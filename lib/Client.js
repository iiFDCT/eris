...
class Client extends EventEmitter {
    ...
    */
    createInteractionResponse(interactionID, interactionToken, options) {
        ...
        if(options.content === undefined && !options.file && !options.embeds && options.flags === undefined) {
            return Promise.reject(new Error("No content, embeds, file or flags"));
        }
        return this.requestHandler.request("POST", Endpoints.INTERACTION_RESPOND(interactionID, interactionToken), true, {
            type: options.type,
            data: {
    ...
    */
    editWebhookMessage(webhookID, token, messageID, options) {
        if(options.content === undefined && !options.embeds && !options.file && options.flags === undefined) {
            return Promise.reject(new Error("No content, embeds, file, or flags"));
        }
