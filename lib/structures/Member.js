...
* @prop {String} tag The username and discriminator of the user
...
* @prop {String} displayName The server nickname of the member, of their username if they don't have one set
...
class Member extends Base {
    ...
    get highestRole() {
        ...
        if (roles.length == 0) {
            ...
            return roles.map((r) => this.guild.roles.get(r)).sort((a, b) => b.position - a.position)[0].id;
        }
    }
